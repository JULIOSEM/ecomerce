...
export default function NavbarComponent() {
  ...
  return (
    <nav className="border-gray-200 bg-black relative">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse relative">
          ...
          <div
            className={`absolute right-0 top-8 z-50 my-4 text-base list-none bg-second-color divide-y divide-gray-100 rounded-lg shadow ${isDropdownOpen ? 'block' : 'hidden'
              }`}
            id="user-dropdown"
          >
        ...
        {/* Mobile menu items */}
        <div
          className={`top-16 left-0 w-full bg-second-color md:hidden ${isMenuOpen ? 'block' : 'hidden'
            }`}
          id="mobile-menu"
        >
